...
// full admin index with pagination is not exposed publicly.
Route::get('currencies/public', [CurrencyController::class, 'publicIndex']);

// ✅ ADD THIS LINE: Email verification resend (public, but requires email in body)
...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::prefix('admin')
        ...
        ->group(function () {
            ...
            Route::post('backup',                 [BackupController::class, 'create'])->middleware('role:super-admin');
            Route::get('backups',                 [BackupController::class, 'index'])->middleware('role:super-admin');
            Route::get('backups/{file}/download', [BackupController::class, 'download'])->middleware('role:super-admin');
            Route::delete('backups/{file}',       [BackupController::class, 'destroy'])->middleware('role:super-admin');
        });
});
